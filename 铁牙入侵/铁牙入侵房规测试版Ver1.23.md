...
破敌：破敌以及类破敌能力在攻击某一特定种类的生物时特别有效。在对抗此类生物时，它的增强加值比正常时多+2，并能造成2d6点额外伤害，如果是通过某些能力获得的临时破敌效果则降低为1d8。
...
高等破敌（Greater Bane, Ex）：到了12级，当审判者使用【破敌】能力时，武器对抗特定生物所获得的额外伤害增加为3d6。

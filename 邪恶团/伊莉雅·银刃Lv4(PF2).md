...
<details>
<summary>
2级职业专长:心能者入门(Psychic Dedication)
</summary>
...
你的相位矢能暂时将命中目标的掩护移位。在成功时，降低目标的AC环境加值（如果有）1点，直到你的下一回合开始。你也获得如下增幅：

增幅 你的相位矢进入完全相移，变得无形无影，直到射入目标——仿佛它传送到了目标中一般。目标对此次攻击措手不及。此外，相位矢忽略数值等同法术等级一半的硬度与穿刺伤害抗性。大成功时，目标不能受到传送效果影响，直到你的下回合开始。
